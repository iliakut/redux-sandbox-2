...
export const COUNTER_ONE_ASYNC_ERROR_GET_NAME = 'COUNTER_ONE_ASYNC_ERROR_GET_NAME';
export const COUNTER_ONE_ASYNC_LOADING_GET_NAME = 'COUNTER_ONE_ASYNC_LOADING_GET_NAME';
